...
public class ManipulaSilabas {
	...
	public ManipulaSilabas(Niveis nivel) throws ArquivoException
	{
		...
		switch(nivel) 
		{
			...
			case NIVEL3:
				...
				break;
			default:
				throw new ArquivoException("A dificuldade selecionada Ã© invÃ¡lida.");
		}
		...
		switch(dificuldade)
		{
			case NIVEL1:
				...
				if(numSilabasPalavra < 2 || numSilabasPalavra > 3 || numSilabasPalavra + extras.length != numTotalSilabas)
					throw new ArquivoException("O nÃºmero de sÃ­labas fornecido Ã© invÃ¡lido.");
	...
	/*public static void main(String[] args) throws ArquivoException
	{
		...
		try
		{
			...
			else System.out.println("Não inseriu!");
		}catch(ArquivoException e)
		{
			e.getMessage();
			e.fillInStackTrace();
