...
public class Palavra {
	...
	String   silabasConcatenadas; 	// Armazena as sílabas da palavra concatenadas, ou seja, a palavra.
	...
	public Palavra (char[] linha, int silabas)	throws ArquivoException
	{
		...
		if(linha == null)
			throw new ArquivoException("Foi passado um valor nulo como parametro da função.");
		...
		// Variável que armazena a soma do número de sílabas, constituintes ou não, da palavra.
		...
		int contador = 0;
		int inicioSilaba; // Servirá para armazenar em qual índice da palvra a sílaba começará
		...
		for(int i = 0; i < numSilabas; i++)
		{
			...
			// Trata os possíveis casos em que o parâmetro "sílabas" foi passado incorretamente.
